...
- Filter case notifications to start 4 weeks prior to the introduction date of the Delta variant and to stop 4 weeks after Delta has become dominant.
...
setkey(who, location_name, date)
who[, cases := frollsum(cases_new, n = 7), by = "location_name"]
